...
public class HUD extends Module{
    ...
    public static ValueBoolean totaltime = new ValueBoolean("Total Playtime", true);
    ...
    public void onRenderGameOverlay(float partialTicks) {
	    ...
	    if (HUD.totaltime.getValue().booleanValue()) {
	      if (lasttime != tick) {
	        ...
	        Display.setTitle(String.valueOf(Wrapper.getClientName()) + " [" + String.valueOf(String.valueOf(decimalFormat.format((tick / 3600))) + ":" + decimalFormat.format((tick % 3600 / 60)) + ":" + decimalFormat.format((tick % 60)) + "]"));
	      } 
	    } else {
	...
	public void renderLogo() {
        ...
        int color = ColorUtils.setColor(new Color(222, 222, 222).getRGB(), 0.5f);
        String s = Wrapper.getClientName().toUpperCase();
        RenderUtils.drawRect(logoX, offsetY, (logoX + logoWidth + 20), (offsetY + logoHeigth), color);
        Wrapper.FONT_MANAGER.RotundaBlack.drawString(s, logoX + 5, offsetY + 5, new Color(31, 31, 31, 255).getRGB());
        ...
        if (coordinfo.getValue()) {
            ...
            RenderUtils.drawRect(infoX, infoY, infoWidth, (infoY + infoHeigth), color);
            Wrapper.FONT_MANAGER.Tahoma.drawString(string, infoX + 2, infoY + 3, new Color(31, 31, 31, 255).getRGB());
        ...
        if (bpsinfo.getValue()) {
            ...
            int result = Math.round(f2 * 15.5f);
            String string3 = "bps: " + result;
            ...
            RenderUtils.drawRect(n14, infoY, n15, (infoY + infoHeigth), color);
            Wrapper.FONT_MANAGER.Tahoma.drawString(string3, n14 + 2, infoY + 3, new Color(31, 31, 31, 255).getRGB());
            infoY = infoY + infoHeigth;
        }
    }
