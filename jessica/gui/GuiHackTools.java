...
public class GuiHackTools extends GuiScreen
{
  ...
  protected void actionPerformed(GuiButton guibutton)
  {
    ...
    if (guibutton.id == 0) this.mc.displayGuiScreen(this.parentScreen);
    else if (guibutton.id == 1) this.mc.displayGuiScreen(new GuiProxy(this.parentScreen));
    else if (guibutton.id == 2) this.mc.displayGuiScreen(new GuiAltManager(this.parentScreen));
    else if (guibutton.id == 3) this.mc.displayGuiScreen(new GuiBungeeIpNick(this.parentScreen));
    else if (guibutton.id == 4)
    {
      GuiHttpPostBrute ps2 = new GuiHttpPostBrute();
      ps2.setVisible(true);
    }
    else if (guibutton.id == 7) this.mc.displayGuiScreen(new GuiSpoofUUID(this.parentScreen));
