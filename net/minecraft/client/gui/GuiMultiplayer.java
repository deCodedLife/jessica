...
public class GuiMultiplayer extends GuiScreen
{
    ...
    protected final ServerPinger oldServerPinger = new ServerPinger();
    protected final GuiScreen parentScreen;
    protected ServerSelectionList serverListSelector;
    private ServerList savedServerList;
    protected GuiButton btnEditServer;
    protected GuiButton btnSelectServer;
    protected GuiButton btnDeleteServer;
    protected boolean deletingServer;
    protected boolean addingServer;
    protected boolean editingServer;
    protected boolean directConnect;

    /**
     * The text to be displayed when the player's cursor hovers over a server listing.
     */
    protected String hoveringText;
    protected ServerData selectedServer;
