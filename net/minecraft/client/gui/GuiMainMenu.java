...
public class GuiMainMenu extends GuiScreen
{
    ...
    public void initGui()
    {
        ...
        this.buttonList.add(new GuiButton(0, (this.width) / 2 - 100, defaultHeight + 48, 98, 20, I18n.format("menu.options", new Object[0])));
        this.buttonList.add(new GuiButton(4, (this.width) / 2 + 2, defaultHeight + 48, 98, 20, I18n.format("menu.quit", new Object[0])));
    ...
    private void addSingleplayerMultiplayerButtons(int p_73969_1_, int p_73969_2_) {
      int defaultHeight = this.height / 4 + 48;
      this.buttonList.add(new GuiButton(1, (this.width) / 2 - 100, defaultHeight, 98, 20, I18n.format("menu.singleplayer", new Object[0])));
      this.buttonList.add(new GuiButton(2, (this.width) / 2 + 2, defaultHeight, 98, 20, I18n.format("menu.multiplayer", new Object[0])));
      this.buttonList.add(new GuiButton(10, (this.width) / 2 - 100, defaultHeight + 24, 98, 20, I18n.format("Hack Tools", new Object[0])));
      this.buttonList.add(new GuiButton(20, (this.width) / 2 + 2, defaultHeight + 24, 98, 20, I18n.format("Contacts", new Object[0])));
      this.buttonList.add(new GuiButton(30, (this.width - this.width) / 2 + 6, 5, 98, 20, I18n.format("Matrix", new Object[0])));
    }
    ...
    protected void actionPerformed(GuiButton button) throws IOException {
        ...
        if (button.id == 1) this.mc.displayGuiScreen(new GuiWorldSelection(this));
        if (button.id == 2) this.mc.displayGuiScreen(new GuiServerList(this));
        if (button.id == 10) this.mc.displayGuiScreen((GuiScreen)new GuiHackTools(this));
        if (button.id == 14 && this.realmsButton.visible) switchToRealms();
        if (button.id == 4) this.mc.shutdown();
        if (button.id == 6 && Reflector.GuiModList_Constructor.exists()) this.mc.displayGuiScreen((GuiScreen)Reflector.newInstance(Reflector.GuiModList_Constructor, new Object[] { this }));
        if (button.id == 20) this.mc.displayGuiScreen((GuiScreen)new GuiContacts(this));
        if (button.id == 11) this.mc.launchIntegratedServer("Demo_World", "Demo_World", WorldServerDemo.DEMO_WORLD_SETTINGS);
        if (button.id == 30) renderMatrix = !renderMatrix;
        if (renderMatrix) Minecraft.getMinecraft().fontRendererObj.drawStringWithShadow("Matrix is on", 20, 5, 0xffffff);
        else Minecraft.getMinecraft().fontRendererObj.drawStringWithShadow("Matrix is off", 20, 5, 0xffffff);
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks)
    {
		...
		mc.fontRendererObj.drawCenteredString("NewJessica", (float)this.width / 4f, (float)this.height / 8.0f, 4673984);
		GL11.glColor4f(1f, 1f, 1f, 1f);
		GL11.glPopMatrix();
		mc.fontRendererObj.drawCenteredString("b5.0.1", (float)this.width / 1.75f, (float)this.height / 4.2f, 4673984);
        ...
        RenderUtils.drawRect((float)this.width / 2.0f - (float)115, (float)this.height / 4.0f + (float)35, 
